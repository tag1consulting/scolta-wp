...
class Scolta_Rest_Api {
	...
	public static function register_routes(): void {
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( self::class, 'handle_expand' ),
				'permission_callback' => array( self::class, 'check_search_permission' ),
				'args'                => array(
					'query' => array(
						'required'          => true,
						'type'              => 'string',
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( self::class, 'handle_summarize' ),
				'permission_callback' => array( self::class, 'check_search_permission' ),
				'args'                => array(
					'query'   => array(
						'required'          => true,
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( self::class, 'handle_followup' ),
				'permission_callback' => array( self::class, 'check_search_permission' ),
				'args'                => array(
					'messages' => array(
						'required'          => true,
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( self::class, 'handle_build_progress' ),
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( self::class, 'handle_rebuild_now' ),
				'permission_callback' => fn() => current_user_can( 'manage_options' ),
				'args'                => array(
					'force' => array(
						'type'    => 'boolean',
