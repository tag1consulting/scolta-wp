	...
	public static function render_budget_notice(): void {
		...
		<div class="notice notice-error">
			<p>
				...
				$message = esc_html__( 'Scolta: Your Amazee.ai budget has been exceeded. AI-powered search features are temporarily unavailable. %s to restore AI search.', 'scolta-ai-search' ); // phpcs:ignore Generic.Files.LineLength.MaxExceeded
